...
public class ApplicationManifestDifferenceFactory {
	...
	protected PropertiesDiff getDeploymentPropertiesDifference(
		...
		existingDeploymentProperties.remove(CFReleaseManager.SPRING_CLOUD_DEPLOYER_COUNT);
		replacingDeploymentProperties.remove(CFReleaseManager.SPRING_CLOUD_DEPLOYER_COUNT);
