...
public class SpringCloudDeployerReleaseManager implements ReleaseManager {

	public static final String SPRING_CLOUD_DEPLOYER_COUNT = "spring.cloud.deployer.count";

	private static final Logger logger = LoggerFactory.getLogger(SpringCloudDeployerReleaseManager.class);
	...
	public SpringCloudDeployerReleaseManager(ReleaseRepository releaseRepository,
	...
	public boolean canSupport(Release release) {
		return this.applicationManifestReader.canSupport(release.getManifest().getData());
	}
